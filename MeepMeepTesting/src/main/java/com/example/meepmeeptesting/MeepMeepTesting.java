...
public class MeepMeepTesting {
    public static void main(String[] args) {
        ...
        bot.runAction(bot.getDrive().actionBuilder(new Pose2d(60, -20, Math.toRadians(180)))
                        ...
                        .strafeToSplineHeading(new Vector2d(44.5, -27), Math.toRadians(270))
                        .splineToConstantHeading(new Vector2d(35.5, -60), Math.toRadians(270))
                        ...
                        .splineToConstantHeading(new Vector2d(12, -55), Math.toRadians(270))
                        ...
                        .splineToConstantHeading(new Vector2d(-12, -51), Math.toRadians(270))
